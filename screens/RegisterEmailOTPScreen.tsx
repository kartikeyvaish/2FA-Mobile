...
import { VerifyRegisterOTP } from "../api/API";

// function component for RegisterEmailOTPScreen
function RegisterEmailOTPScreen({ route }: AuthScreenProps<"RegisterEmailOTPScreen">) {
  // contexts
  ...
  const onSubmitOTPPress = async (values: typeof OTPSchema.InitialValues) => {
    try {
      ...
      SetLoading(true);
      const apiResponse: any = await VerifyRegisterOTP({
  ...
  return (
    <View style={styles.container}>
      <AppText text="Enter OTP sent to your mail." style={styles.headingStyle} />
...
// exports
export default RegisterEmailOTPScreen;
